...
describe('component displaying a blog', () => {
    test('renders the blogs title and author, but does not render its URL or number of likes by default.', () => {
        ...
        <Blog blog={blog} setNotificationMessage={setNotificationMessageMock}></Blog>
        )
        ...
        expect(element).not.toHaveTextContent('https://www.youtube.com/watch?v=lKum7GDQxOY')
    ...
    test('blogs URL and number of likes are shown when the button controlling the shown details has been clicked.', async () => {
        ...
        expect(element).toHaveTextContent('https://www.youtube.com/watch?v=lKum7GDQxOY')
    ...
    test('blogs URL and number of likes are shown when the button controlling the shown details has been clicked.', async () => {
        ...
        const { container } = render(
        <Blog blog={blog} setNotificationMessage={setNotificationMessageMock} addLike={addLikeMock}></Blog>
        )
