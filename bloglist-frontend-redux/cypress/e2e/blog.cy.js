describe("Blog app", function () {
  ...
  describe("When logged in", function () {
    ...
    it("the user who created a blog can delete it.", function () {
      ...
      cy.contains("Test Blog 3").parent().find(".expand-button").click();
    ...
    it("the creator can see the delete button of a blog, not anyone else.", function () {
      ...
      cy.contains("Test Blog 4").parent().find(".expand-button").click();
    ...
    it("blogs are ordered according to likes", function () {
      ...
      cy.contains("Test Blog 2").parent().find(".expand-button").click();
      cy.get(".like-button").click();
      cy.wait(2000);
      cy.get(".like-button").click();
      cy.wait(2000);
